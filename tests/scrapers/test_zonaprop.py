...
import tucasa.parsers.zonaprop.listado
import tucasa.parsers.zonaprop.propiedad
...
class TestPropiedad(unittest.TestCase):
    ...
    def test_parser_propiedad_true(self):
        departamento = tucasa.parsers.zonaprop.propiedad.Propiedad(url_departamento)
        prop = departamento._es_propiedad
        self.assertTrue(prop)

    def test_parser_propiedad_false(self):
        with self.assertWarns(UserWarning):
            propiedad = tucasa.parsers.zonaprop.propiedad.Propiedad(url_listado)
        prop = propiedad._es_propiedad
        self.assertFalse(prop)

    def test_parser_propiedad_local_true(self):
        departamento = tucasa.parsers.zonaprop.propiedad.Propiedad(descarga_departamento, True)
        prop = departamento._es_propiedad
        self.assertTrue(prop)

    def test_parser_propiedad_local_false(self):
        with self.assertWarns(UserWarning):
            propiedad = tucasa.parsers.zonaprop.propiedad.Propiedad(descarga_listado, True)
        prop = propiedad._es_propiedad
        self.assertFalse(prop)

    def test_ambientes_1(self):
        propiedad = tucasa.parsers.zonaprop.propiedad.Propiedad(descarga_departamento, True)
        ambientes = propiedad.ambientes
        self.assertEqual(ambientes, 4)

    def test_ambientes_2(self):
        propiedad = tucasa.parsers.zonaprop.propiedad.Propiedad(descarga_departamento2, True)
        ambientes = propiedad.ambientes
    ...
    def test_antiguedad_3(self):
        propiedad = tucasa.parsers.zonaprop.propiedad.Propiedad(descarga_departamento3, True)
        antiguedad = propiedad.antiguedad
    ...
    def test_alquiler_5(self):
        propiedad = tucasa.parsers.zonaprop.propiedad.Propiedad(descarga_departamento5, True)
        alquiler = propiedad.alquiler
    ...
    def test_expensas_4(self):
        propiedad = tucasa.parsers.zonaprop.propiedad.Propiedad(descarga_departamento4, True)
        expensas = propiedad.expensas
    ...
    def test_direccion_6(self):
        propiedad = tucasa.parsers.zonaprop.propiedad.Propiedad(descarga_departamento6, True)
        direccion = propiedad.direccion
        self.assertEqual(direccion, "Av. Luis María Campos 1308")

    def test_direccion_7(self):
        propiedad = tucasa.parsers.zonaprop.propiedad.Propiedad(descarga_departamento7, True)
        direccion = propiedad.direccion
...
class TestListado(unittest.TestCase):
    ...
    def test_parser_listado_true(self):
        listado = tucasa.parsers.zonaprop.listado.Listado(url_listado)
        prop = listado.es_mi_navegacion_esperada()
        self.assertTrue(prop)

    def test_parser_listado_false(self):
        with self.assertWarns(UserWarning):
            listado = tucasa.parsers.zonaprop.listado.Listado(url_departamento)
        prop = listado.es_mi_navegacion_esperada()
        self.assertFalse(prop)

    def test_parser_listado_local_true(self):
        listado = tucasa.parsers.zonaprop.listado.Listado(descarga_listado, True)
        prop = listado.es_mi_navegacion_esperada()
        self.assertTrue(prop)

    def test_parser_listado_local_false(self):
        with self.assertWarns(UserWarning):
            listado = tucasa.parsers.zonaprop.listado.Listado(descarga_departamento, True)
        prop = listado.es_mi_navegacion_esperada()
        self.assertFalse(prop)
    ...
    def test_lista_propiedades_2(self):
        listado = tucasa.parsers.zonaprop.listado.Listado(descarga_listado2, True)
        propiedades = listado._propiedades_div()
        self.assertEqual(len(propiedades), 20)

    def test_propiedades_url(self):
        listado = tucasa.parsers.zonaprop.listado.Listado(descarga_listado, local=True)
        lista_url = listado.propiedades_url()
        self.assertEqual(len(lista_url), 15)

    def test_propiedades_url_2(self):
        listado = tucasa.parsers.zonaprop.listado.Listado(descarga_listado2, local=True)
        lista_url = listado.propiedades_url()
